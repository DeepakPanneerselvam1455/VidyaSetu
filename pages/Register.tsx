...
const RegisterPage: React.FC = () => {
    ...
    const handleConfirmRegistration = async () => {
        ...
        setError(null);
        try {
            // Role is forced to 'student' by the backend trigger — no role selection from UI
            await api.register({ name, email }, password);
            // Log in the user automatically after registration
            const loggedInUser = await login(email, password);

            // Redirect based on assigned role (always student from DB trigger)
            ...
            <div className="w-full max-w-[520px]">
                <div className="auth-card p-8 sm:p-10">
                    ...
                    <form onSubmit={handleInitialSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    style={{ 
                                        paddingLeft: '3rem',
                                        borderColor: fieldErrors.name ? 'hsl(0 65% 50%)' : undefined
                                    }}
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    style={{
                                        paddingRight: '2.5rem',
                                        paddingLeft: '3rem',
                                        borderColor: fieldErrors.confirmPassword ? 'hsl(0 65% 50%)' : undefined
                                    }}
                        ...
                        {/* Role Info - forced student */}
                        <div className="rounded-lg p-3" style={{ backgroundColor: 'var(--surface-nested, rgba(128,128,128,0.06))', border: '1px solid var(--border-default)' }}>
                            <p className="text-xs" style={{ color: 'var(--text-secondary)' }}>
                                All new accounts are created as <strong style={{ color: 'var(--text-heading)' }}>Students</strong>.
                                Contact an administrator to request an Instructor or Admin role.
                            </p>
                        </div>
            ...
            >
                <div className="space-y-6 my-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-lg font-medium capitalize" style={{ color: 'var(--text-heading)' }}>Student</p>
                    </div>
                </div>
