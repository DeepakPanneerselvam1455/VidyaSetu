    ...
    return (
        <>
            <button
                ...
                className="fixed bottom-6 right-6 bg-violet-600 text-white p-4 rounded-full shadow-lg hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-400 focus:ring-offset-2 focus:ring-offset-slate-900 transition-transform hover:scale-110"
            ...
            {isOpen && (
                <div className="fixed bottom-24 right-6 w-[90vw] max-w-md h-[70vh] max-h-[600px] bg-slate-900/80 backdrop-blur-sm border border-slate-700 rounded-2xl shadow-2xl flex flex-col animate-in fade-in-0 slide-in-from-bottom-5 duration-300">
                    {/* Header */}
