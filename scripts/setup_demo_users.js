...
const DEMO_CREDENTIALS = {
    student: { email: 'student@skillforge.com', password: 'student123', role: 'student', name: 'Demo Student' },
    instructor: { email: 'instructor@skillforge.com', password: 'instructor123', role: 'mentor', name: 'Demo Instructor' },
    admin: { email: 'admin@skillforge.com', password: 'admin123', role: 'admin', name: 'Demo Admin' },
};
