...
const TutoringRoom: React.FC = () => {
    ...
    if (!session) {
        return <div className="p-8 text-center text-error">Session not found.</div>;
    }
    ...
    return (
        <div className="h-[calc(100vh-4rem)] bg-background relative">
            {isWaiting ? (
                <div className="flex flex-col items-center justify-center h-full text-text space-y-6">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-text-muted mt-2 text-lg">Your instructor hasn't started the session yet.</p>
                        <p className="text-text-muted mt-1">Refreshes automatically...</p>
                    </div>
                </div>
            ) : (
