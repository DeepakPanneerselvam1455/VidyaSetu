...
const RegisterPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-main flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-md bg-surface rounded-2xl shadow-xl p-8 border border-default">
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center gap-2">
                        <FlameIcon className="w-8 h-8 text-primary" />
                        <h1 className="text-4xl font-bold text-primary">VidyaSetu</h1>
                    </div>
                    <h2 className="text-2xl mt-4 font-semibold text-main">Create Account</h2>
                    <p className="text-muted mt-1">Learn. Create. Excel.</p>
                </div>
                <form onSubmit={handleInitialSubmit} className="space-y-4">
                    <div>
                        <label className="text-sm font-medium text-main">Full Name</label>
                        <div className="relative">
                            <UserIcon className="absolute left-3.5 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-muted" />
                            <Input
                                type="text"
                    ...
                    <div>
                        <label className="text-sm font-medium text-main">Account Type</label>
                        <Select
                            value={role}
                            onChange={(e) => setRole(e.target.value as User['role'])}
                            className="bg-main border-default text-main focus:border-focus focus:ring-primary"
                        >
                    ...
                    {isPasswordWeak && (
                        <p className="text-xs text-center text-warning">Password must be at least 'Medium' strength.</p>
                    )}
                </form>
            ...
            >
                <div className="space-y-4 my-4 text-main">
                    <div>
