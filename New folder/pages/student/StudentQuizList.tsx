    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-text">My Assigned Quizzes</h1>
                    <p className="text-text-muted">Quizzes assigned to you by your instructors.</p>
                </div>
                ...
                <CardContent className="p-0">
                    <div className="overflow-x-auto">
                        <table className="w-full text-left">
                            <thead className="text-xs text-text-muted uppercase bg-secondary/50">
                                <tr>
                            ...
                            <tbody>
                                {filteredQuizzes.length > 0 ? (
                                    filteredQuizzes.map((quiz) => (
                                        <tr key={quiz.id} className="bg-card border-b border-border hover:bg-secondary/50 transition-colors">
                                            <td className="px-6 py-4 font-medium text-text">{quiz.title}</td>
                                            <td className="px-6 py-4 text-text-muted">{quiz.courseTitle}</td>
                                    ...
                                    <tr>
                                        <td colSpan={5} className="text-center p-8 text-text-muted">No quizzes found.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
